...
export const zhCN: Dict = {
  ...
  "entry.discordAria": "加入 Dragon Design Discord",
  "entry.discordAriaWithOnline": "加入 Dragon Design Discord - {online}",
  "entry.discordOnlineLabel": "{count} 在线",
  "entry.followXLabel": "在 X 上关注 @OpenDesignHQ",
  "entry.followThreadsLabel": "Follow Dragon Design on Threads",
  "entry.followInstagramLabel": "在 Instagram 上关注 @opendesign.ai",
  "entry.followLinkedinLabel": "在 LinkedIn 上关注 Dragon Design",
  "entry.followXiaohongshuLabel": "在小红书上关注 Dragon Design",
  "entry.youtubeLabel": "Dragon Design on YouTube",
  ...
  "entry.githubStarAria": "在 GitHub 上为 Dragon Design 点亮 Star",
  ...
  "socialShare.openDesignTitle": "GitHub 上的 Dragon Design",
  "socialShare.openDesignText":
    "Dragon Design 是开源的设计智能工作区，可以生成、编辑、部署并交付设计产物。",
  ...
  "socialShare.projectText":
    "我用 Dragon Design 做了 {title}。查看已部署产物，也推荐收藏仓库：{repo}",
  "socialShare.projectCopyText":
    "我用 Dragon Design 做了 {title}\n{url}\nDragon Design 仓库：{repo}",
  ...
  "designFiles.usefulInfoTip18":
    "在 YouTube 上订阅 Dragon Design，观看教程和演示。",
  "designFiles.usefulInfoTip19":
    "在 LinkedIn 上关注 Dragon Design，了解产品动态。",
  "designFiles.usefulInfoTip20":
    "在小红书上关注 Dragon Design，获取技巧和灵感。",
