...
export function buildDesignManifestContent(opts: {
  ...
  const title = opts.title || 'Dragon Design artifact';
...
- Keep generated product UI free of Dragon Design chrome, preview labels, or design-process annotations.
...
- Do not keep prototype-only annotations, frame labels, or Dragon Design chrome in the production UI.
