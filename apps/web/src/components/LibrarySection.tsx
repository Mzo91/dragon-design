...
// zero-config — it connects automatically whenever Dragon Design is running
      ...
      <header className="entry-section__head">
        ...
        <div className={styles.clipperHint}>
          ...
          >
            ...
            Get the Dragon Design Web Clipper
          </a>
        </div>
      </header>
      ...
      {loading && assets.length === 0 ? (
        ...
        <div className={styles.empty}>
          ...
          <p className={styles.emptyHint}>
            Clip from any page with the Dragon Design Web Clipper, run{' '}
