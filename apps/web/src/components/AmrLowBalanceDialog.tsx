...
interface Props {
  ...
  /** Dragon Design Cloud profile from the warning snapshot; picks the console origin. */
  profile: string | null;
...
// SOFT pre-run reminder for Dragon Design Cloud tasks: the wallet can still
