...
type EntryCreateProjectInput = Omit<CreateInput, 'metadata'> & {
  ...
  /** The home submit already ran the Dragon Design Cloud balance gate; the
...
export function EntryShell({
  ...
  async function handlePluginLoopSubmit(payload: PluginLoopSubmit) {
    // Dragon Design Cloud pre-run balance gate: hard blocks (empty wallet or
...
function OnboardingView({
  ...
  // Dragon Design Cloud sign-in in one gesture. Mirrors the old AMR card's
  ...
  // Connect step, default face: a minimal, centered Dragon Design Cloud sign-in
    ...
    return (
      ...
      >
        ...
        <footer className="onboarding-cloud__footer">
          © {new Date().getFullYear()} Dragon Design · {t('settings.onboardingCloudRights')}
        </footer>
      </section>
    );
  }
