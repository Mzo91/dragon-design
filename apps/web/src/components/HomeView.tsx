...
const AUTHORING_DEFAULT_SCENARIO_INPUTS = {
  artifactKind: 'Dragon Design plugin',
  audience: 'Dragon Design plugin authors',
  topic: 'packaging a reusable workflow as an Dragon Design plugin',
};
...
export function HomeView({
  ...
  async function handlePickWorkingDir() {
    ...
    if (isOpenDesignHostAvailable()) {
      ...
      setError(
        `Couldn't open the folder picker (${'reason' in result ? result.reason : 'host unavailable'}). Please update Dragon Design and try again.`,
      );
      return null;
    }
